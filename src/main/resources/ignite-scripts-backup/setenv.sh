...
export USER_LIBS='/Users/juntingma/.m2/repository/com/vividsolutions/jts/1.13/jts-1.13.jar:/Users/juntingma/Developer/jt/ignite/ignite-spring-data-demo/target/ignite-spring-data-demo-0.0.3-SNAPSHOT.jar'
echo $USER_LIBS
...
#
# Env var to print content of binary object
#
IGNITE_SENSITIVE_DATA_LOGGING="plain"
